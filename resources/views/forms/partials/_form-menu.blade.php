...
<ul class="dropdown-menu dropdown-menu-right">
    ...
    @if ($form->status === $form::STATUS_OPEN)
        <li><a data-toggle="modal" data-target="#share-form">Share Form</a></li>
    @endif
    <li><a href="javascript:void(0)" data-toggle="modal" data-target="#form-collaborate">Form Collaborators</a></li>
    ...
    @if (Route::currentRouteName() !== 'forms.show')
        <li><a href="{{ route('forms.show', $form->code) }}">View Form</a></li>
    @endif
    ...
    @if ($form->status !== $form::STATUS_OPEN)
        <li><a href="javascript:void(0)" id="delete-button" data-href="{{ route('forms.destroy', $form->code) }}" data-item="form - {{ $form->title }}">Delete Form</a></li>
    @endif
